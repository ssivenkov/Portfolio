...
export const Projects = () => {
  return (
    <div id={'projects'} className={styles.generalContainer}>
      <section className={styles.contentContainer}>
        ...
        <div className={styles.projectsContainer}>
          ...
          <Project
            ...
            description={
              'SPA for generation secure random passwords. Implemented: create random password page with password settings(length, uppercase letters, lowercase letters, numbers, symbols) and copy password button, recommendations page, change color theme bar on all pages.'
            }
          ...
          <Project
            ...
            technologies={
              'JavaScript, TypeScript, React, Redux, Redux-thunk, Axios, Classnames, SCSS, ESLint, Prettier'
            }
